...
{
    [clsTaskMetaInfo("BPB Check E1 Function", "ClsBPB_CheckE1Function", true)]
    public class ClsBPB_CheckE1Function : ITask
    {
        ...
        public ClsBPB_CheckE1Function()
        {
            m_bStopWhenFail = true;
            AllowExcution = true;
            m_strDescription = "BPB Check E1 Function";
            E1_PORT = E1_PORT.PORT1;
            RetryTimes = 3;
            Result_unit = "";
        }
        [Browsable(false)]
        ...
        public string Name
        {
            get { return "ClsBPB_CheckE1Function"; }
        }
        [Browsable(false)]
        ...
        public TaskResult Excution(CFTWinAppCore.DeviceManager.IDeviceManager DevManager)
        {
            ...
            try
            {
               ...
               // IBPBDevice bPBDevice = (IBPBDevice)DevManager.GetDevService(SysDevType.DUT.ToString());
                ...
                bool bOk = false;
                MessageBox.Show("Nối LOOP E1 Port");
                for (int i = 0; i < RetryTimes; i++)
                {
                        bOk = bPBDevice.CheckE1Port(E1_PORT);
                        if (bOk)
                        {
                            break;
                        }
        ...
        public ITask Clone()
        {
            ClsBPB_CheckE1Function task = new ClsBPB_CheckE1Function();
        ...
        [DisplayName("E1 PORT")]
        [SaveAtt()]
        public E1_PORT E1_PORT { set; get; }
        [Category("Task Parameter")]
