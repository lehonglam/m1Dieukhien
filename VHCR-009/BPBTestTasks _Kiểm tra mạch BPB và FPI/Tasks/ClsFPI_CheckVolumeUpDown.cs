...
{
    [clsTaskMetaInfo("FPI Check Volume Up Down", "ClsFPI_CheckVolumeUpDown", true)]
    public class ClsFPI_CheckVolumeUpDown : ITask
    {
        ...
        public ClsFPI_CheckVolumeUpDown()
        {
            m_bStopWhenFail = true;
            AllowExcution = true;
            m_strDescription = "FPI Check Volume Up Down";
            Result_unit = "";
            //DeltaLimit = 1;
        }
        [Browsable(false)]
        ...
        public string Name
        {
            get { return "ClsFPI_CheckVolumeUpDown"; }
        }
        [Browsable(false)]
        ...
        public TaskResult Excution(CFTWinAppCore.DeviceManager.IDeviceManager DevManager)
        {
            ...
            try
            {
                ...
                System.Windows.Forms.DialogResult dialogResult = clsMsgHelper.ShowYesNo("Check Volume Up/Down", "Tăng giảm âm lượng bằng nút bấm, âm lượng có thay đổi không?");
        ...
        public ITask Clone()
        {
            ClsFPI_CheckVolumeUpDown task = new ClsFPI_CheckVolumeUpDown();
            clsSaveTaskParaHelper.CopyObjProperties(this, task);
            return task;
        }
        //[Category("Task Parameter")]
        //[DisplayName("Delta Limit(V)")]
        //[SaveAtt()]
        //public double DeltaLimit { set; get; }
