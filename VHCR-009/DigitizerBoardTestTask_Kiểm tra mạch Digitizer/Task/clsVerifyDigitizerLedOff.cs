...
{
    [clsTaskMetaInfo("Verify digitizer board led off", "clsVerifyDigitizerLedOff", true)]
    public class clsVerifyDigitizerLedOff : ITask
    {
        ...
        public clsVerifyDigitizerLedOff()
        {
            m_bStopWhenFail = true;
            AllowExcution = true;
            m_strDescription = "Verify digitizer board led off";
            Result_unit = "";
        }
        [Browsable(false)]
        ...
        public string Name
        {
            get { return "clsVerifyDigitizerLedOff"; }
        }
        [Browsable(false)]
        public int TypeMes
        {
        ...
        public TaskResult Excution(CFTWinAppCore.DeviceManager.IDeviceManager DevManager)
        {
            ...
            try
            {
                ...
                bOK = DutService.CheckLedOff();
                if (clsMsgHelper.ShowYesNo("Question", "Tất cả LED có tắt không?") == DialogResult.Yes)
                {
                    bOK = true;
                }
                else
        ...
        public ITask Clone()
        {
            clsVerifyDigitizerLedOff task = new clsVerifyDigitizerLedOff();
