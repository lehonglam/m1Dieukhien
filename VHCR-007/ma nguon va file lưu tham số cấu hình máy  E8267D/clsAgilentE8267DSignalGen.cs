...
{
    [SysDevMetaAtt(typeof(clsAgilentE8267DSignalGen), SysDevType.SIG_GEN, "E8267D Signal Gen")]
    public class clsAgilentE8267DSignalGen : IAccessDeviceService, ISignalGenDeviceE8267D
    {
        private IISMessage m_IOService = null;
        private clsDeviceInfor m_devInfo;

        public clsAgilentE8267DSignalGen(clsDeviceInfor devInfo)
        {
            m_devInfo = devInfo;
        }
        ...
        {
            bool status=m_IOService.SendCommand(":FREQuency:MODE CW");
        ...
        public bool SetModulationType(ModulatioType modType)
        {
            ...
            switch (modType)
            {
                case ModulatioType.OFF:
                    ...
                    status &= m_IOService.SendCommand("FM:OFF");
                    break;
